...
do
    ...
    IP_ADDRESS=$(aws ec2 run-instances --image-id ami-0b4f379183e5706b9 --instance-type $INSTANCES_TYPE --security-group-ids 
    sg-0e6e277cb9db6a9b2 --tag-specifications "ResourceType=instance,Tags=[{Key=Name,Value=$i}]"
